            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-5">About Us Edit :) Click here for back to full list - <a class="btn btn-success" href="{{ route('about-us.index') }}">About Us</a></h4>

                                <div class="row">
                                    <div class="col-md-8 offset-md-2">
                                        <form method="POST" action="{{ route('about-us.update', $aboutUsEdit->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="dignity" placeholder="Dignity" class="form-control @error('dignity') is-invalid @enderror" id="dignity" value="{{ $aboutUsEdit->dignity }}">
                                                    @error('dignity')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="sub_text" rows="3" class="form-control @error('sub_text') is-invalid @enderror" id="sub_text">{{ $aboutUsEdit->sub_text }}</textarea>
                                                    @error('sub_text')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="full_div row form-group col-md-10">
                                                    @foreach($nameEdit as $key=>$name)
                                                        <div class="col-sm-4">
                                                            <input type="text" name="name[]" placeholder="Name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ $name }}">
                                                            @error('name')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" name="about_content[]" placeholder="About Content" class="form-control @error('about_content') is-invalid @enderror" id="about_content" value="{{ $about_contentEdit[$key] }}">
                                                            @error('about_content')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="about_me" rows="5" class="form-control @error('about_me') is-invalid @enderror" id="about_me">{{ $aboutUsEdit->about_me }}</textarea>
                                                    @error('about_me')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
