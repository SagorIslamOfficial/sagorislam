            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-5">Fact Edit :) Click here for back to full list - <a class="btn btn-success" href="{{ route('fact.index') }}">Fact</a></h4>

                                <div class="row">
                                    <div class="col-md-8 offset-md-2">
                                        <form method="POST" action="{{ route('fact.update', $factEdit->id) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group row">
                                                ...
                                                <div class="full_div row form-group col-md-10">
                                                    @foreach($totalEdit as $key=>$total)
                                                        <div class="col-sm-4">
                                                            <input type="number" name="total[]" placeholder="Total" class="form-control @error('total') is-invalid @enderror" id="facts" value="{{ $total }}">
                                                            @error('total')
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" name="name[]" placeholder="Name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ $nameEdit[$key] }}">
                                                            @error('name')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
