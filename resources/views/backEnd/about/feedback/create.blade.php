            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-5">Feedback Create :) Click here for back to full list - <a class="btn btn-success" href="{{ route('feedback.index') }}">List</a></h4>
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <form method="POST" action="{{ route('feedback.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="message" placeholder="Message" rows="5" class="form-control @error('message') is-invalid @enderror" id="dignity"></textarea>
                                                    @error('message')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
