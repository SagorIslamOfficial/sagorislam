            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-5">Skill Create :) Click here for back to full list - <a class="btn btn-success" href="{{ route('skill.index') }}">List</a></h4>
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <form method="POST" action="{{ route('skill.store') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" name="progress" placeholder="Progress %" class="form-control @error('progress') is-invalid @enderror" id="progress">
                                                    @error('progress')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
