            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-5">Home Create :) Click here for back to full list - <a class="btn btn-success" href="{{ route('home.index') }}">List</a></h4>
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <form method="POST" action="{{ route('home.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="big_text" placeholder="Your Name" class="form-control @error('big_text') is-invalid @enderror" value="{{ old('big_text') }}" id="big_text">
                                                    @error('big_text')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="small_text" placeholder="Your Profession Name" class="form-control @error('small_text') is-invalid @enderror" value="{{ old('small_text') }}" id="small_text">
                                                    @error('small_text')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="link" placeholder="Put A Link To Go Another Page" class="form-control @error('link') is-invalid @enderror" value="{{ old('link') }}" id="link">
                                                    @error('link')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="footer_text" placeholder="Footer Text Info" class="form-control @error('footer_text') is-invalid @enderror" value="{{ old('footer_text') }}" id="footer_text">
                                                    @error('footer_text')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="footer_link" placeholder="Developer Site Link" class="form-control @error('footer_link') is-invalid @enderror" value="{{ old('footer_link') }}" id="footer_link">
                                                    @error('footer_link')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="full_div row form-group col-md-10">
                                                    <div class="col-sm-4">
                                                        <input type="text" name="social_icon[]" placeholder="Social Icon(Feather Icons)" class="form-control @error('social_icon') is-invalid @enderror" value="{{ old('social_icon') }}" id="social_icon">
                                                        @error('social_icon')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" name="social_link[]" placeholder="Social Account Link" class="form-control @error('social_link') is-invalid @enderror" value="{{ old('social_link') }}" id="social_link">
                                                        @error('social_link')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
