            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('category.index') }}">Fact</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-5">Fact Edit :) Click here for back to full list - <a class="btn btn-success" href="{{ route('category.index') }}">Fact</a></h4>
                                        ...
                                        <form method="POST" action="{{ route('category.update', $editCategory->id) }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="row form-group col-md-10">
                                                    <input type="text" name="name" placeholder="Category Name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ $editCategory->name }}">
                                                    @error('name')
