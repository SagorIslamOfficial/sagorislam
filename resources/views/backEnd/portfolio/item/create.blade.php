            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-5">Item Create :) Click here for back to full list - <a class="btn btn-success" href="{{ route('item.index') }}">List</a></h4>
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <form method="POST" action="{{ route('item.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="row form-group col-md-10">
                                                    <input type="text" name="pd_title" placeholder="Portfolio long title" class="form-control @error('pd_title') is-invalid @enderror" id="pd_title">
                                                    @error('pd_title')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="full_div row form-group col-md-10">
                                                    <div class="col-sm-4">
                                                        <input type="text" name="pd_section[]" placeholder="Portfolio details category" class="form-control @error('pd_section') is-invalid @enderror" id="pd_section">
                                                        @error('pd_section')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" name="pd_s_content[]" placeholder="Portfolio details category Content" class="form-control @error('pd_s_content') is-invalid @enderror" id="pd_s_content">
                                                        @error('pd_s_content')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="row form-group col-md-5">
                                                    <input type="text" name="pd_link" placeholder="Client website link" class="form-control @error('pd_link') is-invalid @enderror" id="pd_link">
                                                    @error('pd_link')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <div class="row form-group col-md-5">
                                                    <input type="text" name="pd_link_text" placeholder="Client website text" class="form-control @error('pd_link_text') is-invalid @enderror" id="pd_link_text">
                                                    @error('pd_link_text')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="row form-group col-md-10">
                                                    <textarea name="pd_description" class="form-control @error('pd_description') is-invalid @enderror" placeholder="Portfolio details description" id="pd_description"></textarea>
